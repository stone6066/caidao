...
@property (nonatomic, strong) NSString *myAllwaysFlash;
...
- (void)typerequest:(DPRequest *)request didReceiveRawData:(NSData *)data;
- (void)typerequest:(DPRequest *)request didFinishLoadingWithResult:(id)result;

- (void)loginrequest:(DPRequest *)request didReceiveRawData:(NSData *)data;
