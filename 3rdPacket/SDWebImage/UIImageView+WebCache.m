...
- (void)sd_setImageWithStr:(NSString *)urlStr {
    if(![urlStr isEqual:[NSNull null]]) {
        
        [self sd_setImageWithURL:[NSURL URLWithString:urlStr] placeholderImage:nil options:0 progress:nil completed:nil];
    }
    else
    {
        self.image=[UIImage imageNamed:DefaultsImage];
    }
}
