...
@interface AOScrollerView : UICollectionViewCell<UIScrollViewDelegate,UrLImageButtonDelegate>
{
    int pageNumer;//页码
    int switchDirection;//方向
    NSMutableArray *imageNameArr;//图片数组
    NSMutableArray *titleStrArr;//标题数组
    NSMutableArray *_dealUrlArr;//跳转url
...
//titleArr：标题数组
//height：视图高度
// NSMutableArray *dealUrl;//跳转url dealUrl:(NSMutableArray *)dealUrlArr
